...
extern "C" android::status_t _ZN7android13GraphicBuffer10reallocateEjjijy(uint32_t inWidth, uint32_t inHeight,
        android::PixelFormat inFormat, uint32_t inLayerCount, uint64_t inUsage);

extern "C" android::status_t _ZN7android13GraphicBuffer10reallocateEjjij(uint32_t inWidth, uint32_t inHeight,
        android::PixelFormat inFormat, uint32_t inLayerCount, uint32_t inUsage) {
    return _ZN7android13GraphicBuffer10reallocateEjjijy(inWidth, inHeight, inFormat, inLayerCount,
